...
- Beobachtung: eine konkrete, wertfreie Beschreibung dessen, was beobachtbar passiert ist, ohne Interpretation oder Vorwurf. Vermeide dabei auch wertende Einordnungs-Verben wie "vorwirft", "beschuldigt" oder "unterstellt" – auch das ist bereits eine Interpretation, keine reine Beobachtung. WICHTIG: Enthält der Originaltext irgendein konkretes Zitat, eine konkrete Aussage oder eine konkrete Situation, nutze genau diese wörtlich oder sinngemäß, auch wenn der Text zusätzlich ein verallgemeinerndes Wort wie "immer" oder "nie" enthält. Erfinde NIEMALS eine neue, im Originaltext nicht vorkommende konkrete Situation, auch nicht als vermeintliches Beispiel – das ist eine Tatsachenbehauptung über etwas, das so nie gesagt oder getan wurde. Verwende die Formulierung "zum Beispiel" in der Beobachtung grundsätzlich NICHT. Nur wenn der Originaltext wirklich gar keine konkrete Aussage oder Situation enthält (reine Verallgemeinerung ohne jeden Anhaltspunkt, z. B. "Er ist nie für mich da"), formuliere die Beobachtung stattdessen als die eigene, subjektive Wahrnehmung der Person selbst (z. B. "Wenn ich das Gefühl habe, dass..."), ohne dabei eine konkrete, aber erfundene Situation zu behaupten.
