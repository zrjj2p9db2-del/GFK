...
Prüfe zuerst, ob der Originaltext die vier GFK-Schritte bereits weitgehend selbst enthält (konkrete Beobachtung, echtes Gefühl, erkennbares Bedürfnis, klare Bitte). Falls ja: Würdige das ausdrücklich und anerkennend, z. B. in der Art von "Das ist schon ziemlich nah an gewaltfreier Kommunikation!" oder "In deinem Text steckt schon viel von dem, worum es in der GFK geht!" – und übernimm den Originaltext im GFK-Text dann möglichst wortgleich, ohne eine kosmetische Umformulierung zu erzwingen, nur um etwas verändert zu haben.
...
- Gefühl: ein echtes Gefühl der sprechenden Person, kein verdecktes Urteil über die andere Person (kein Pseudogefühl). Prüfe das gewählte Gefühlswort mit dem Testsatz "Darauf reagiere ich [Wort]" – klingt er stimmig und beschreibt er einen inneren Zustand, ist es ein echtes Gefühl. Klingt er seltsam oder beschreibt er eigentlich eine Handlung der anderen Person, ist es ein Pseudogefühl.
